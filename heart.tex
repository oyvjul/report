...
If the smale-scale processes for the cases such as defibrillation could be described in terms of precise mathematical models, the task of combining the mathematical models into a full model that describes the complete process, is a viable approach. Although, keep in mind that the interaction between the different different smale-scale processes that eventually makes a complete description of the heart can be a complex and time consuming process, that opposes a serious computational challenge.

The method of simulating the heart in a structured manner has not yet been tested and documented. The new method of heart simulation are of great interest to ongoing research activities at the Cardiac Modeling Department at Simula 

%%The full-scale 3d heart simulations 


%%leave section with math exp that will be used later and descirbe functions in the heart
